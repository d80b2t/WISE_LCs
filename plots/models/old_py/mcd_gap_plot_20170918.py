...
ax1.plot(speclam_sdss/(1+redshift),    specflux_sdss, color='b', linewidth=1)
ax1.plot(speclam_boss/(1+redshift),    specflux_boss, color='r', linewidth=1)
ax1.plot(speclam_Palr/(1+redshift),    specflux_Palr, color='k', linewidth=1)
ax1.plot(speclam_Palb/(1+redshift),    specflux_Palb, color='k', linewidth=1)

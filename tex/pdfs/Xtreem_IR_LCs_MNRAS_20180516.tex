...
telescope or data reduction.  One significant aspect of the BOSS
...
slits. We note that the 2017 Palomar data was photometric, while
2018 Palomar data was not.  Both Palomar  spectra were flux calibrated using the
sensitivity function calculated from the photometric night (in 2017),
and then the spectra were scaled to have (roughly) matching 
[O\,{\sc iii}] line strengths.
...
equivalent width has decreased by a factor of $\sim$1.7.  This first
measurements implies that the luminosity of the broad line region has
significantly changed relative to the narrow line region.  The second
point suggests that the continuum has decreased at a different rate
than the broad line emission. Despite the factor of 3.4 drop in the
H$\beta$ line flux (normalized to [O\,{\sc iii}]), the continuum only
shows about 30\% of this decrease.  This suggests the continuum and
broad lines are respond differently to mechanism driving the changes.
\fi 

%Interestingly, when w
We fit the SDSS spectrum for J1100-0053 with the
...
\citet{Steinhardt_Silverman2013}.  
...
\begin{table}
 \centering
  ...
  log L(H$\beta$, broad)        & 43.05$\pm$0.02   & 42.76$\pm$0.02 &42.29$\pm$0.02   & 42.44$\pm$0.03 \\
   ...
   log L(H$\beta$, total)         & 43.06$\pm$0.02    &42.760$\pm$0.02 &42.294$\pm$0.02 & 42.44$\pm$0.03\\
log  L([O\,{\sc iii}])                & 42.20$\pm$0.04 &42.282$\pm$0.01 & 41.61$\pm$0.11& 41.86$\pm$0.03 \\

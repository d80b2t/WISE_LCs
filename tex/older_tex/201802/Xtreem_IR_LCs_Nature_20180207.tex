...
%%   SECTION 5   SECTION 5   SECTION 5   SECTION 5   SECTION 5   SECTION 5  
%%   SECTION 5   SECTION 5   SECTION 5   SECTION 5   SECTION 5   SECTION 4  
%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\newblock \bibinfo{title}{{Quasar viscosity crisis}}.
\newblock \emph{\bibinfo{journal}{Nature Astronomy}}
  \textbf{\bibinfo{volume}{2}}, \bibinfo{pages}{102–103}
  (\bibinfo{year}{2018}).
\newblock \eprint{1110.0854}.

\bibitem{Shields1978}
\bibinfo{author}{{Shields}, G.~A.}
\newblock \bibinfo{title}{{Thermal continuum from acretion disks in quasars}}.
\newblock \emph{\bibinfo{journal}{\nat}} \textbf{\bibinfo{volume}{272}},
  \bibinfo{pages}{706--708} (\bibinfo{year}{1978}).

\bibitem{Malkan_Sargent1982}
\bibinfo{author}{{Malkan}, M.~A.} \& \bibinfo{author}{{Sargent}, W.~L.~W.}
\newblock \bibinfo{title}{{The ultraviolet excess of Seyfert 1 galaxies and
  quasars}}.
\newblock \emph{\bibinfo{journal}{\apj}} \textbf{\bibinfo{volume}{254}},
  \bibinfo{pages}{22--37} (\bibinfo{year}{1982}).

\bibitem{Antonucci1993}
\bibinfo{author}{{Antonucci}, R.}
\newblock \bibinfo{title}{{Unified models for active galactic nuclei and
  quasars}}.
\newblock \emph{\bibinfo{journal}{\araa}} \textbf{\bibinfo{volume}{31}},
  \bibinfo{pages}{473--521} (\bibinfo{year}{1993}).

\bibitem{Perlman2008}
\bibinfo{author}{{Perlman}, E.}, \bibinfo{author}{{Addison}, B.},
  \bibinfo{author}{{Georganopoulos}, M.}, \bibinfo{author}{{Wingert}, B.} \&
  \bibinfo{author}{{Graff}, P.}
\newblock \bibinfo{title}{{Thermal AGN signatures in blazars}}.
\newblock In \emph{\bibinfo{booktitle}{Blazar Variability across the
  Electromagnetic Spectrum}}, \bibinfo{pages}{9} (\bibinfo{year}{2008}).
\newblock \eprint{0807.2119}.

\bibitem{Lasota2016}
\bibinfo{author}{{Lasota}, J.-P.}
\newblock \bibinfo{title}{{Black Hole Accretion Discs}}.
\newblock In \bibinfo{editor}{{Bambi}, C.} (ed.)
  \emph{\bibinfo{booktitle}{Astrophysics of Black Holes: From Fundamental
  Aspects to Latest Developments}}, vol. \bibinfo{volume}{440} of
  \emph{\bibinfo{series}{Astrophysics and Space Science Library}},
  \bibinfo{pages}{1} (\bibinfo{year}{2016}).
\newblock \eprint{1505.02172}.
...
\bibitem{Pringle1981}
\bibinfo{author}{{Pringle}, J.~E.}
\newblock \bibinfo{title}{{Accretion discs in astrophysics}}.
\newblock \emph{\bibinfo{journal}{\araa}} \textbf{\bibinfo{volume}{19}},
  \bibinfo{pages}{137--162} (\bibinfo{year}{1981}).
...
\newblock \eprint{arXiv:astro-ph/0601558}.
...
\bibitem{Clavel1991}
\bibinfo{author}{{Clavel}, J.} \emph{et~al.}
\newblock \bibinfo{title}{{Steps toward determination of the size and structure
  of the broad-line region in active galactic nuclei. I - an 8 month campaign
  of monitoring NGC 5548 with IUE}}.
\newblock \emph{\bibinfo{journal}{\apj}} \textbf{\bibinfo{volume}{366}},
  \bibinfo{pages}{64--81} (\bibinfo{year}{1991}).

\bibitem{Ulrich1997}
\bibinfo{author}{{Ulrich}, M.-H.}, \bibinfo{author}{{Maraschi}, L.} \&
  \bibinfo{author}{{Urry}, C.~M.}
\newblock \bibinfo{title}{{Variability of Active Galactic Nuclei}}.
\newblock \emph{\bibinfo{journal}{\araa}} \textbf{\bibinfo{volume}{35}},
  \bibinfo{pages}{445--502} (\bibinfo{year}{1997}).

\bibitem{VandenBerk2004}
\bibinfo{author}{{Vanden Berk}, D.~E.} \emph{et~al.}
\newblock \bibinfo{title}{{The Ensemble Photometric Variability of \~{}25,000
  Quasars in the Sloan Digital Sky Survey}}.
\newblock \emph{\bibinfo{journal}{\apj}} \textbf{\bibinfo{volume}{601}},
  \bibinfo{pages}{692--714} (\bibinfo{year}{2004}).
\newblock \eprint{arXiv:astro-ph/0310336}.

\bibitem{Pereyra2006}
\bibinfo{author}{{Pereyra}, N.~A.} \emph{et~al.}
\newblock \bibinfo{title}{{Characteristic QSO Accretion Disk Temperatures from
  Spectroscopic Continuum Variability}}.
\newblock \emph{\bibinfo{journal}{\apj}} \textbf{\bibinfo{volume}{642}},
  \bibinfo{pages}{87--95} (\bibinfo{year}{2006}).
\newblock \eprint{astro-ph/0506006}.

\bibitem{MacLeod2010}
\bibinfo{author}{{MacLeod}, C.~L.} \emph{et~al.}
\newblock \bibinfo{title}{{Modeling the Time Variability of SDSS Stripe 82
  Quasars as a Damped Random Walk}}.
\newblock \emph{\bibinfo{journal}{\apj}} \textbf{\bibinfo{volume}{721}},
  \bibinfo{pages}{1014--1033} (\bibinfo{year}{2010}).
\newblock \eprint{1004.0276}.

\bibitem{Guo2016b}
\bibinfo{author}{{Guo}, H.} \& \bibinfo{author}{{Gu}, M.}
\newblock \bibinfo{title}{{The Optical Variability of SDSS Quasars from
  Multi-epoch Spectroscopy. II. Color Variation}}.
\newblock \emph{\bibinfo{journal}{\apj}} \textbf{\bibinfo{volume}{822}},
  \bibinfo{pages}{26} (\bibinfo{year}{2016}).
\newblock \eprint{1603.06876}.
...
\bibitem{Zimmerman2005}
\bibinfo{author}{{Zimmerman}, E.~R.}, \bibinfo{author}{{Narayan}, R.},
  \bibinfo{author}{{McClintock}, J.~E.} \& \bibinfo{author}{{Miller}, J.~M.}
\newblock \bibinfo{title}{{Multitemperature Blackbody Spectra of Thin Accretion
  Disks with and without a Zero-Torque Inner Boundary Condition}}.
\newblock \emph{\bibinfo{journal}{\apj}} \textbf{\bibinfo{volume}{618}},
  \bibinfo{pages}{832--844} (\bibinfo{year}{2005}).
\newblock \eprint{astro-ph/0408209}.
...
\bibitem{Ivezic2008}
\bibinfo{author}{{Ivezic}, Z.} \& \bibinfo{author}{{Tyson}, J.~A.~f.}
\newblock \bibinfo{title}{{LSST: from Science Drivers to Reference Design and
  Anticipated Data Products}}.
\newblock \emph{\bibinfo{journal}{ArXiv e-prints}}  (\bibinfo{year}{2008}).
\newblock \eprint{0805.2366}.

\bibitem{LSST_ScienceBookV2}
\bibinfo{author}{{LSST Science Collaborations}} \emph{et~al.}
\newblock \bibinfo{title}{{LSST Science Book, Version 2.0}}.
\newblock \emph{\bibinfo{journal}{ArXiv e-prints}}  (\bibinfo{year}{2009}).
\newblock \eprint{0912.0201}.

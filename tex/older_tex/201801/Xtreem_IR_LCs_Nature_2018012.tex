...
\cite{LaMassa2015, Runnoe2016, MacLeod2016, Ruan2016, Yang2017}.  The
...
structure appear more likely than changes in obscuration
\cite{Hutsemekers2017, Sheng2017}.  Here we report on three epochs of
spectroscopy of SDSS J110057.70-005304.5, a quasar at a redshift of
$z=0.378$ whose UV continuum and broad hydrogen emission lines have
dramatically faded over the past $\approx$20 years. The change in this
quasar was initially identified in the infrared, and an archival
spectrum from 2010 shows an intermediate phase of the transition
during which the flux below rest-frame 3400\AA\ has collapsed. This
...
infrared flux should follow, occuring on a $\sim$3 year observed
...
or appearance, of strong UV continuum and/or prominent broad emission
...
Rumbaugh2017, Yang2017}, yet poorly understood. Changes in obscuration
are generally disfavoured due to the timescales currently observed
\cite{Hutsemekers2017, Sheng2017}, and it is clear that changing-look
quasars are a key laboratory for understanding accretion physics and
...
%As noted in \cite{Zimmerman2005}, for given $M, \dot{M}$ and $R_{\rm in}$, a standard-torque disk model has approximately twice the maximum temperature and exactly 3 times the luminosity of a disk with zero torque. The extra luminosity is due to the work done by the nonzero torque at the inner edge of the accretion disk. 
...
%We discuss this object and the \cite{Guo2016} result further in the Supplemental Material. 
...
%By monitoring changing look quasars we introduce new tests of models of accretion disk physics and a new probe of the strong gravity regime.
